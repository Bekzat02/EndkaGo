...
func (c *calculatorServiceClient) PrimeNumberDecomposition(ctx context.Context, in *NumberRequest, opts ...grpc.CallOption) (CalculatorService_PrimeNumberDecompositionClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[0], "/endtermPrimeCompostion.CalculatorService/PrimeNumberDecomposition", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *calculatorServiceClient) ComputeAverage(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_ComputeAverageClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[1], "/endtermPrimeCompostion.CalculatorService/ComputeAverage", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *calculatorServiceComputeAverageClient) Send(m *NumbersRequest) error {
...
func (x *calculatorServiceComputeAverageServer) Recv() (*NumbersRequest, error) {
